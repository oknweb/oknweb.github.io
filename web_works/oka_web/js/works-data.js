const worksData = [
  ...
  },
  {
    ...
    modal: {
      ...
      overview: '宇宙(SORA)をイメージした都会のユニークなカフェSORAのためのプロモーションムービー。マーケティング授業の課題として設定した架空の喫茶店のInstagram向けPV。Z世代がメインターゲットのため、生成AIを使用したアニメーション表現でSORAの持つユニークな世界観が伝わるよう制作しました。',
      points: '先に曲を作り、曲調や詩に合わせて各シーンを構成していきました。青空、夕焼け、星空。それぞれを見上げる人々がカフェSORAに集う...そんなイメージをテンポよく構成しました。',
      links: [
